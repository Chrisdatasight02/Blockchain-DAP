...
const getMetadata = useCallback(
  async(form)=> {
    ...
    try {
      ...
      const metadataPDA = PublicKey.findProgramAddressSync([Buffer.from("metadata"), PROGRAM_ID.toBuffer(), tokenMint.toBuffer(),],
          ...
          {!loaded ? (
              ...
              <div className="my-auto p-6 text-center">
                ...
                <div className="mb-6 text-center">
                  <button onClick={()=> getMetadata(tokenAddress)} className="bg-primary-600/90 hover:bg-primary-600 group mt-5 inline-flex w-full 
              ...
              <div className="my-auto p-6 text-center">
                ...
                <div className="mt-5 w-full text-center">
                  ...
                  <InputView name={"Token Address"} 
                    ...
                    />
                  <div className="mb-6 text-center">
                    <a href={tokenMetadata?.uri} target="_blank" rel="noreferrer" className="bg-primary-600/90 hover:bg-primary-600 group mt-5 inline-flex w-full items-center justify-center rounded-lg px-6 py-2
