...
import { Keypair, 
  ...
  const createToken = useCallback(
      ...
      if(file){
        try {
          ...
          const response = await axios({
            ...
            data: formData, 
            headers: {
              pinata_api_Key: "b75d8c52d7f953f93a86",
              pinata_secret_api_Key: "de2b977a8c449b6f757241c9c6ec24b74552404ed1486c251d8b999f62995b68",
    ...
    //METADATA
      ...
      try {
        ...
        notify({type: "error", message: "Uploaded to Pinnata json failed"});
  ...
  return (
    <>
    { isLoading && (
      <div className="absolute top-0 left-0 z-0 flex h-screen items-center
    ...
    {tokenMintAddress ? (
      <section className="flex w-full items-center py-6 px-0 lg:h-screen">
        <div className="container">
          <div className="bg-default-950/40 mx-auto max-w-5xl overflow-hidden rounded-2xl backdrop-blur-xl">
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="ps-4 hidden py-4 pt-10 lg:block">
              <div className="upload relative w-full-hidden rounded-xl">
                {
                  token.image ? (
              ...
              <textarea rows="6" onChange={(e)=> handleFormFieldChange("description", e)} className="border-default-200 relative mt-48 block w-full rounded border-white bg-transparent py-1.5 px-3 text-white/80 focus:border-white/25 
            ...
            <div className="lg:ps-0 flex flex-col p-10">
              <div className="pb-6 my-auto">
                ...
                <p className="text-default-300 mb-8 max-w-sm">
                 Kindly provide all the datails about your token
                ...
                <div className="text-start">
                  ...
                  <div className="mb-6 text-center ">
                    <button onClick={()=> createToken(token)} className="bg-primaary-600/90 
                    hover:bg-primary-600 group mt-5 inline-flex w-full items-center 
                    justify-center rounded-lg px-6 py-2
                     text-white backdrop-blur-2xl transition-all duration-500" type="submit">
            ...
            <div className="lg:ps-0 flex h-full flex-col p-10">
              ...
              <div className="my-auto p-6 text-center">
                ...
                <p className="text-default-300 mx-auto mb-5 max-w-sm">
                  Your solana token is successufuly created, Check now explorer
                </p>
                ...
                <div className="mt-5 w-full text-center">
                  ...
                  <div className="mb-6 text-center">
                    <a href={`https://explorer.solana.com/address/${tokenMintAddress}?cluster=${networkConfiguration}`} target="_blank" rel="noreferrer" className="bg-primary-600/90 hover:bg-primary-600 group mt-5 inline-flex w-full items-center justify-center rounded-lg px-6 py-2
                     text-white backdrop-blur-2xl transition-all duration-500">
                      <span className="fw-bold">
                        View on solana
                      </span>
                     </a>
