...
import {TiSocialFacebook,
   ...
   TiSocialTwitter,
    ...
    export const Footer: FC = ()=> {
      ...
      const menuOne = ["Support Center", 
        "Customer Support", 
        "About Us", 
        "Project",
         "Return Policy"];
         const menuTwo = ["Support Center", 
          "Press Inquiries", 
            ...
            <footer className="bg-default-950/40 backdrop-blur-3xl">
                    ...
                    <div className="p-10 ">
                      ...
                      <form  onSubmit={handleSubmit} className="mb-6 space-y-2 ">
                        ...
                        <div className="relative">
                          <input type="email" id="email" name="email" className="bg-default-950/60 pe-40 ps-4 h-12 w-full rounded-lg border-white/10 py-4
                           text-white backdrop-blur-3xl
                            focus:border-white/10 focus:ring-0"/>
                            <button type="submit" disabled={state.submitting} className="hover:bg-primary-hover 
                            hover:border-primary-hover border-primary bg-primary end-[6px] absolute top-[6px] 
                            inline-flex h-9 items-center justify-center gap-2 rounded-md px-6
              ...
              text-center md:justify-between lg:px-20">
                <p className="text-default-400 text-base font-medium ">
                  ...
                  <a href="#">
                    Design & Created <i data-lucide="heart"
                     className="inline h-4 w-4
                      fill-red-500 text-red-500"></i>
                      by Datasight communications
                  </a>
                </p>
                <p className="text-default-400 text-base font-medium">
                  Terms & Policy
